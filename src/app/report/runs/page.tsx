  ...
  return (
    <section className="space-y-4">
      <div className="rounded-xl border border-zinc-200 bg-white p-4">
        ...
        <p className="mt-1 text-sm text-zinc-600">{t("runs.desc")}</p>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <div className="rounded-xl border border-zinc-200 bg-white p-4">
          ...
          <pre className="mt-2 h-56 overflow-auto rounded bg-zinc-950 p-3 text-xs text-zinc-50">
      ...
      <div className="rounded-xl border border-zinc-200 bg-white p-4">
        ...
        {loading ? <p className="mt-2 text-sm text-zinc-600">{t("runs.loadingLogs")}</p> : null}
        <ul className="mt-2 space-y-2">
          {runs.map((run) => (
            <li key={run.run_id} className="rounded border border-zinc-200 p-3 text-sm">
              ...
              <p className="mt-1 text-xs text-zinc-600">{run.output_paths.join(", ")}</p>
            </li>
          ))}
        </ul>
      </div>
