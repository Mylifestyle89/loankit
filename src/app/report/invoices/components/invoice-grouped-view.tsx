              ...
              <div className="flex items-center justify-between gap-3">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <Link
                    ...
                    className="cursor-pointer rounded-lg p-1.5 text-zinc-400 hover:text-primary-500 hover:bg-primary-50 dark:hover:text-primary-400 dark:hover:bg-primary-500/10 transition-colors"
                  >
                ...
                <div className="h-2 rounded-full bg-zinc-100 dark:bg-white/[0.06] overflow-hidden">
                  <div
                    className={`h-full rounded-full transition-all duration-500 ${
                      isFull ? "bg-emerald-500" : pct > 50 ? "bg-primary-500" : "bg-primary-500"
                    }`}
                    style={{ width: `${pct}%` }}
                  />
                </div>
