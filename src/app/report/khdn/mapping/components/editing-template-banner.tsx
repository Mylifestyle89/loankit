...
export function EditingTemplateBanner({
  ...
  const secondaryActionClass =
    "rounded-xl border border-slate-200/60 dark:border-white/[0.07] bg-slate-50/50 dark:bg-white/[0.04] px-3 py-2 text-sm font-medium text-slate-700 dark:text-slate-200 transition-all hover:bg-amber-50/30 dark:hover:bg-amber-500/10 active:scale-95";
  ...
  return (
    <div className="grid gap-3 rounded-2xl border border-slate-200/60 dark:border-white/[0.07] bg-white/80 dark:bg-[#141414]/90 p-3 shadow-[0_8px_30px_rgb(0,0,0,0.04)] backdrop-blur-md md:grid-cols-[minmax(0,1fr)_auto] md:items-center">
      <div className="flex min-w-0 flex-wrap items-center gap-2 rounded-xl border border-slate-200/60 dark:border-white/[0.07] bg-slate-50/50 dark:bg-white/[0.04] p-2">
        <span className="rounded-xl bg-amber-50 dark:bg-amber-500/10 px-2.5 py-1 text-sm font-semibold text-amber-700 dark:text-amber-400">
        ...
        <input
          ...
          className="h-10 min-w-[220px] flex-1 rounded-xl border border-slate-200/60 dark:border-white/[0.09] bg-slate-50/50 dark:bg-white/[0.05] dark:text-slate-100 px-3 text-sm text-slate-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500/40"
        />
      </div>
      ...
      <div className="flex flex-wrap items-center gap-2 md:justify-end">
        <button
          ...
          className="rounded-xl bg-gradient-to-r from-amber-600 to-orange-500 px-3 py-2 text-sm font-medium text-white shadow-md transition-all hover:brightness-110 active:scale-95 disabled:pointer-events-none disabled:opacity-50"
        >
