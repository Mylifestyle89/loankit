      ...
      >
                    ...
                    <button
                      ...
                      className={`flex w-full items-center gap-2 px-3 py-2 text-left text-sm transition-colors ${
                        selectedFile === b.filename
                          ? "bg-amber-50/80 text-amber-800 dark:bg-amber-500/10 dark:text-amber-400"
        ...
        <div className="mt-5 flex flex-wrap justify-end gap-2 border-t border-slate-200/60 pt-4 dark:border-white/[0.07]">
          ...
          <button
            ...
            className="rounded-lg bg-gradient-to-r from-amber-600 to-orange-500 px-3 py-2 text-sm font-medium text-white shadow-md transition-all hover:brightness-110 disabled:opacity-50 disabled:pointer-events-none"
          >
