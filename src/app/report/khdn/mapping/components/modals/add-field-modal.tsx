        ...
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40 p-4">
            <div className="w-full max-w-xl space-y-4 rounded-xl bg-white dark:bg-[#141414]/90 p-5 shadow-2xl">
                ...
                <div className="grid gap-3">
                    <div>
                        <label className="mb-1 block text-sm font-medium text-zinc-700 dark:text-slate-200">Tên hiển thị</label>
                        <input
                            ...
                            className="w-full rounded-md border border-zinc-200 dark:border-white/[0.09] dark:bg-white/[0.05] dark:text-slate-100 px-3 py-2 text-sm"
                            autoFocus
                        />
                    </div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <div>
                            <label className="mb-1 block text-sm font-medium text-zinc-700 dark:text-slate-200">Thuộc Nhóm</label>
                            ...
                            <p className="mt-1 text-xs text-zinc-500 dark:text-slate-400">{t("mapping.groupPathHint")}</p>
                        </div>

                        <div>
                            <label className="mb-1 block text-sm font-medium text-zinc-700 dark:text-slate-200">Kiểu dữ liệu</label>
                            <select
                                value={newField.type}
                                onChange={(e) =>
                                    setNewField((prev) => ({
                ...
                <div className="mt-4 flex justify-end gap-2">
                    <button
                        type="button"
                        onClick={onClose}
                        className="rounded-md border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-primary-50/30"
                    >
                        Hủy
                    </button>
                    <button
                        ...
                        className="flex items-center gap-2 rounded-md bg-primary-500 px-4 py-2 text-sm font-medium text-white hover:brightness-110"
                    >
