            ...
            <div className="w-full max-w-xl space-y-4 rounded-xl bg-white dark:bg-[#141414]/90 p-5 shadow-2xl">
                ...
                <div className="mt-4 flex justify-end gap-2">
                    <button
                        type="button"
                        onClick={onClose}
                        className="rounded-md border border-zinc-200 px-4 py-2 text-sm font-medium text-zinc-700 hover:bg-brand-50/30"
                    >
                        Hủy
                    </button>
                    <button
                        ...
                        className="flex items-center gap-2 rounded-md bg-brand-500 px-4 py-2 text-sm font-medium text-white hover:brightness-110"
                    >
