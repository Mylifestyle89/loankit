            ...
            >
              ...
              <div className="flex w-full items-center gap-2 px-3 py-2 transition-colors hover:bg-slate-50/80 dark:hover:bg-white/[0.04]">
                ...
                >
                  ...
                  <span className="rounded-full bg-amber-100/80 px-2 py-0.5 text-[10px] font-medium text-amber-700 dark:bg-amber-500/15 dark:text-amber-400">
                    ...
                    return (
                      ...
                      >
                        <input
                          ...
                          className="mt-0.5 h-3.5 w-3.5 flex-shrink-0 rounded border-slate-300 text-amber-600 focus:ring-amber-500"
                        />
