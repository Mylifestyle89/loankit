    ...
    >
      ...
      <div className="mt-3 rounded-xl border border-slate-200/60 bg-slate-50/50 px-3 py-2 dark:border-white/[0.07] dark:bg-white/[0.04]">
        ...
        <input
          ...
          className="mt-2 h-10 w-full rounded-xl border border-slate-200/60 bg-white px-3 text-sm text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-slate-100"
          autoFocus
        />
      </div>
    </BaseModal>
