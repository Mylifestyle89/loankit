  ...
  return (
      ...
      footer={
        <div className="flex items-center justify-end gap-2">
          ...
          <button
            ...
            onClick={() => void onSave()}
            disabled={saving}
            className="rounded-xl bg-gradient-to-r from-violet-600 to-fuchsia-600 px-3 py-2 text-sm font-medium text-white transition-all hover:brightness-110 active:scale-95 disabled:opacity-60"
          >
    ...
    >
      ...
      <input
        ...
        className="mt-2 h-10 w-full rounded-xl border border-slate-200/60 bg-slate-50/50 px-3 text-sm text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-slate-100"
        autoFocus
      />
