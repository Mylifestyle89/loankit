      ...
      <div className="w-full max-w-md space-y-3 rounded-lg bg-white dark:bg-[#141414]/90 p-4 shadow-xl">
        ...
        <div className="mt-2 flex justify-end gap-2">
          <button
            type="button"
            onClick={onClose}
            className="rounded-md border border-zinc-200 dark:border-white/[0.09] dark:text-slate-200 px-3 py-1.5 text-xs hover:bg-amber-50/30 dark:hover:bg-white/[0.06]"
          >
            Hủy
          </button>
          <button
            ...
            className="rounded-md bg-gradient-to-r from-amber-600 to-orange-500 px-3 py-1.5 text-xs text-white disabled:opacity-50"
          >
            Thêm nhóm dữ liệu
          </button>
        </div>
