  ...
  return (
    <div className="space-y-4 px-4 py-4">
      ...
      <div className="space-y-1.5">
        ...
        <div className="rounded-lg border-2 border-dashed border-primary-300/80 bg-white/60 px-3 py-3 transition-colors hover:border-primary-400 dark:border-primary-500/30 dark:bg-white/[0.04]">
          <label className="flex cursor-pointer items-center gap-2">
            <Upload className="h-4 w-4 flex-shrink-0 text-primary-500" />
            <span className="text-xs font-medium text-primary-500">{t("autoTagging.chooseFile")}</span>
            <input
              type="file"
              accept=".docx,.doc"
              className="hidden"
      ...
      <div className="space-y-1.5">
        ...
        <textarea
          ...
          className="w-full rounded-lg border border-slate-200/80 bg-white/80 px-3 py-2 text-sm placeholder:text-slate-400 focus:border-primary-500 focus:outline-none focus:ring-1 focus:ring-primary-500 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-slate-100 dark:placeholder:text-slate-500"
        />
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        <label className="inline-flex items-center gap-1.5 text-xs text-slate-700 dark:text-slate-200">
          <input
            ...
            className="h-3.5 w-3.5 border-slate-300 text-primary-500 focus:ring-primary-500"
          />
      ...
      <button
        ...
        className="inline-flex items-center gap-1.5 rounded-lg bg-primary-500 px-3 py-2 text-sm font-medium text-white shadow-sm transition-colors hover:brightness-110 disabled:opacity-70"
      >
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="text-[11px] font-medium text-primary-500 hover:underline dark:text-primary-400"
              >
              ...
              return (
                <motion.label
                  ...
                  className={`flex cursor-pointer items-start gap-3 rounded-xl border p-3 transition-all ${
                    tagging.accepted[idx]
                      ? "border-primary-200/80 bg-primary-50/40 shadow-sm dark:border-primary-500/30 dark:bg-primary-500/10"
                ...
                >
                  <input
                    ...
                    className="mt-0.5 h-4 w-4 flex-shrink-0 rounded border-slate-300 text-primary-500 focus:ring-primary-500"
                  />
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="truncate rounded-md bg-primary-100 dark:bg-primary-500/10 px-2 py-0.5 text-xs font-mono font-medium text-primary-600 dark:text-primary-400">
                        {tag}
                      </span>
                    </div>
          ...
          <div className="flex flex-wrap items-center gap-2 border-t border-slate-200/50 pt-3 dark:border-white/[0.07]">
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-lg bg-primary-500 px-4 py-2 text-sm font-medium text-white shadow-sm transition-all hover:brightness-110 disabled:opacity-60"
            >
