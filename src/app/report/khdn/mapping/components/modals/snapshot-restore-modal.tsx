      ...
      <div className="flex max-h-[80vh] w-full max-w-2xl flex-col rounded-2xl border border-slate-200/60 bg-white/95 shadow-[0_8px_30px_rgb(0,0,0,0.08)] backdrop-blur-md dark:border-white/[0.07] dark:bg-[#141414]/95">
        ...
        <div className="flex items-center justify-between border-b border-slate-200/60 px-5 py-4 dark:border-white/[0.07]">
          <div className="flex items-center gap-2.5">
            <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-brand-100 dark:bg-brand-500/10">
              <History className="h-4.5 w-4.5 text-brand-500 dark:text-brand-400" />
            </div>
            <div>
              ...
              {snapshots.map((s) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 rounded-lg border border-brand-200 bg-brand-50 px-3 py-1.5 text-xs font-medium text-brand-600 transition-all hover:bg-brand-100 active:scale-95 disabled:pointer-events-none disabled:opacity-50 dark:border-brand-500/20 dark:bg-brand-500/10 dark:text-brand-400 dark:hover:bg-brand-500/20"
                  >
