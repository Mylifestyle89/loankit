  ...
  return (
    <div className="border-t border-white/40 px-4 py-4">
      <div className="mb-3 flex flex-wrap items-center justify-between gap-2">
        <h4 className="text-sm font-semibold text-brand-800 dark:text-brand-400">
          {t("mapping.smartAutoBatch.sectionTitle")}
        </h4>
        <div className="inline-flex rounded-md border border-brand-200/60 bg-white/50 p-0.5 text-xs dark:border-brand-500/30 dark:bg-white/[0.04]">
          <button
            type="button"
            onClick={() => setInputMode("manual")}
            className={`rounded px-2 py-1 transition-colors ${inputMode === "manual" ? "bg-brand-600 text-white" : "text-zinc-700 hover:bg-white/60 dark:text-slate-200 dark:hover:bg-white/[0.06]"}`}
          >
          ...
          <button
            ...
            className={`rounded px-2 py-1 transition-colors ${inputMode === "assets" ? "bg-brand-600 text-white" : "text-zinc-700 hover:bg-white/60 dark:text-slate-200 dark:hover:bg-white/[0.06]"}`}
          >
      ...
      <div className="grid gap-3 md:grid-cols-2">
        ...
        <div className="space-y-1.5">
          ...
          <div className="rounded-lg border-2 border-brand-300 bg-white/70 px-3 py-2 shadow-sm transition-colors focus-within:border-brand-500 focus-within:ring-2 focus:ring-brand-200 dark:border-brand-500/30 dark:bg-white/[0.04]">
            {inputMode === "manual" ? (
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="block w-full text-xs file:mr-2 file:rounded-md file:border-2 file:border-brand-400 file:bg-brand-50 file:px-3 file:py-1.5 file:text-xs file:font-medium file:text-zinc-700 file:hover:bg-brand-100"
                />
                {!manualExcelPath && (
              ...
              <>
                <button
                  ...
                  className="rounded-md border-2 border-brand-300 bg-white px-2 py-1.5 text-xs font-medium text-zinc-700 transition-colors hover:border-brand-500 hover:bg-brand-50 dark:border-brand-500/30 dark:bg-white/[0.04] dark:text-slate-200 dark:hover:bg-brand-500/10"
                >
                ...
                <select
                  ...
                  className="mt-2 w-full rounded-lg border-2 border-brand-300 bg-white px-2 py-2 text-sm focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-200 dark:border-brand-500/30 dark:bg-[#141414]/90 dark:text-slate-100"
          ...
          <div className="rounded-lg border-2 border-brand-300 bg-white/70 px-3 py-2 shadow-sm transition-colors focus-within:border-brand-500 focus-within:ring-2 focus:ring-brand-200 dark:border-brand-500/30 dark:bg-white/[0.04]">
            {inputMode === "manual" ? (
              ...
              <select
                ...
                className="w-full rounded-lg border-2 border-brand-300 bg-white px-2 py-2 text-sm focus:border-brand-500 focus:outline-none focus:ring-2 focus:ring-brand-200 dark:border-brand-500/30 dark:bg-[#141414]/90 dark:text-slate-100"
                disabled={inputMode !== "assets"}
              >
        ...
        <label className="text-xs text-zinc-700 dark:text-slate-200">
          ...
          <input
            ...
            className="mt-1 w-full rounded-md border border-brand-200/60 bg-white/50 px-2 py-1.5 text-sm dark:border-brand-500/30 dark:bg-white/[0.04] dark:text-slate-100"
          />
        </label>
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        ...
        <button
          ...
          className="rounded-lg border border-zinc-300 bg-white/80 px-3 py-1.5 text-sm text-zinc-700 transition-colors hover:bg-brand-50 hover:border-brand-300 disabled:opacity-60 dark:border-white/[0.08] dark:bg-white/[0.04] dark:text-slate-200 dark:hover:bg-brand-500/10 dark:hover:border-brand-500/30"
        >
      ...
      {autoProcessJob?.phase === "completed" && autoProcessJob.output_paths.length > 0 && (
        <div className="sticky bottom-0 left-0 right-0 mt-3 border-t border-slate-200/60 bg-slate-50/95 px-4 py-3 backdrop-blur-sm dark:border-white/[0.07] dark:bg-[#141414]/90">
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl bg-brand-500 px-4 py-3 text-sm font-medium text-white shadow-lg shadow-brand-500/25 transition-all hover:brightness-110 hover:shadow-brand-500/30 disabled:opacity-70"
          >
