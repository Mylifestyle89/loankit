...
const inputCls =
  "w-full rounded border border-slate-200 bg-white/80 px-2 py-1 text-xs outline-none focus:border-amber-400 dark:border-white/10 dark:bg-white/5 dark:text-slate-200";
    ...
    <div className="flex flex-col gap-3">
      ...
      <div className="flex items-center justify-between">
        <p className="text-xs text-slate-500 dark:text-slate-400">
          Đã tìm thấy <span className="font-semibold text-amber-600">{items.length}</span> trường
              ...
              {isExpanded && (
                <div className="divide-y divide-slate-50 dark:divide-white/[0.03]">
                  {groupItems.map((item) => (
                    <label
                      key={item.fieldKey}
                      className="flex cursor-pointer items-center gap-3 px-4 py-1.5 hover:bg-amber-50/40 dark:hover:bg-amber-500/5"
                    >
                      <input
                        type="checkbox"
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg bg-amber-600 px-3 py-1.5 text-xs font-medium text-white shadow-sm hover:bg-amber-700 disabled:opacity-40"
          >
