...
export function SuggestTab({
  ...
  return (
    <>
        ...
        <div className="grid gap-4 md:grid-cols-2 md:min-h-[280px]">
          ...
          >
            ...
            <div ref={targetScrollRef} className="min-h-0 flex-1 overflow-y-auto p-4 space-y-3">
              ...
              {grouping ? (
                <div className="rounded-lg border border-primary-200/80 bg-primary-50/60 px-3 py-2 text-xs font-medium text-primary-700">
      ...
      {showReview && (
        <div className="border-t border-primary-200/50 px-4 py-3 dark:border-white/[0.07]">
