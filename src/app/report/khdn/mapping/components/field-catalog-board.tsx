    ...
    <DndContext sensors={sensors} collisionDetection={closestCenter} onDragEnd={onDragEnd} modifiers={[restrictToVerticalAxis]}>
      ...
      >
        <Group orientation="horizontal" className="h-full min-h-0 w-full">
                      ...
                      <div key={node.parent} className="flex flex-col gap-1">
                        <div className="grid grid-cols-[minmax(0,1fr)_auto] items-center gap-1.5">
                          <button
                            ...
                            title={node.parent}
                            className="inline-flex flex-1 min-w-0 items-center gap-1 rounded-lg border border-primary-200 dark:border-primary-500/30 bg-primary-100 dark:bg-primary-500/10 px-2 py-1 text-[11px] font-medium text-primary-700 dark:text-primary-400 transition-colors hover:bg-primary-100 dark:hover:bg-primary-500/20"
                          >
                          ...
                          <button
                            ...
                            className="shrink-0 rounded-md border border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-white/[0.05] p-1.5 text-zinc-500 dark:text-slate-400 transition-colors hover:border-primary-300 hover:bg-primary-50 dark:hover:bg-primary-500/10 hover:text-primary-600 dark:hover:text-primary-400"
          ...
          >
            <div className="h-full w-px rounded-full bg-slate-200/70 transition-colors group-hover:bg-primary-300/80 group-focus-visible:bg-primary-400 group-data-[resize-handle-state=drag]:bg-primary-500" />
            <div className="pointer-events-none absolute inset-y-0 left-1/2 w-2 -translate-x-1/2 rounded-full bg-primary-100/0 transition-colors group-hover:bg-primary-100/70 group-focus-visible:bg-primary-100/80 group-data-[resize-handle-state=drag]:bg-primary-200/80" />
          </Separator>
                  ...
                  {!hasContext ? (
                    ...
                    <>
                      ...
                      <button
                        ...
                        className="flex flex-shrink-0 items-center gap-1.5 rounded-lg bg-primary-500 px-4 py-2 text-sm text-white shadow-sm shadow-primary-500/25 transition-all duration-200 hover:shadow-md hover:shadow-primary-500/30 hover:brightness-110"
                      >
