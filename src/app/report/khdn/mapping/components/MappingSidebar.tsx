              ...
              >
                ...
                <div className="flex shrink-0 items-center justify-between border-b border-slate-200/60 dark:border-white/[0.07] px-4 py-3">
                  ...
                  <button
                    ...
                    title="Đóng"
                    className="rounded-lg p-2 text-slate-600 dark:text-slate-300 transition-all duration-200 hover:bg-slate-100/50 dark:hover:bg-white/[0.07] hover:text-violet-600 dark:hover:text-violet-400"
                  >
                    <X className="h-5 w-5" />
                  </button>
                </div>
