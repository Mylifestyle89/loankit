              ...
              <button
                ...
                className={`inline-flex items-center gap-1 rounded-lg border px-2 py-1 text-[11px] font-medium transition-colors ${
                  child.fields.some((f) => f.is_repeater)
                    ? "border-amber-200 bg-amber-100 text-amber-800 hover:bg-amber-200 dark:border-amber-500/30 dark:bg-amber-500/10 dark:text-amber-300 dark:hover:bg-amber-500/20"
                    : "border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-white/[0.05] text-zinc-600 dark:text-slate-300 hover:border-amber-300 hover:bg-amber-50 hover:text-amber-800 dark:hover:bg-amber-500/10"
                }`}
            ...
            <div className="space-y-4 rounded-lg border border-amber-200/60 bg-amber-50/30 p-4">
              {((Array.isArray(values[child.fullPath]) ? values[child.fullPath] : []) as Record<string, unknown>[]).map(
                (item, index) => (
                  <div
                    key={index}
                    className="rounded-xl border border-amber-200/60 bg-white dark:bg-[#141414]/90 shadow-sm overflow-hidden"
                  >
