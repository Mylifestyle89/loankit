    ...
    <div className="rounded-2xl border border-zinc-200 dark:border-white/[0.07] bg-white dark:bg-[#161616] p-4 shadow-sm">
      ...
      <div className="flex flex-wrap gap-2 mb-3">
        <select
          ...
          className="min-w-48 rounded-lg border border-zinc-200 dark:border-white/[0.09] bg-white dark:bg-[#1a1a1a] dark:text-slate-100 px-3 py-2 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500/40"
        >
        ...
        <div className="relative flex-1 min-w-48">
          ...
          <input
            ...
            className="w-full rounded-lg border border-zinc-200 dark:border-white/[0.09] bg-white dark:bg-[#1a1a1a] dark:text-slate-100 pl-9 pr-3 py-2 text-sm shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-violet-500/40"
          />
        </div>
          ...
          return (
            <div key={group}>
              <button
                ...
                className="flex w-full items-center gap-2 px-3 py-2 text-left text-sm font-medium hover:bg-violet-50/60 dark:hover:bg-violet-950/20 transition-colors"
              >
              ...
              {!isCollapsed && fields.map((field) => (
                <div key={field.field_key} className="flex items-center gap-2 py-1.5 pl-8 pr-3 hover:bg-zinc-100/70 dark:hover:bg-white/[0.03] transition-colors group">
                  <code className="shrink-0 rounded bg-violet-100 dark:bg-violet-500/10 px-1.5 py-0.5 text-xs font-mono text-violet-700 dark:text-violet-400">
                    [{field.field_key}]
                  </code>
