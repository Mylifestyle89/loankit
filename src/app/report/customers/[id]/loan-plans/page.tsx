...
const STATUS_STYLES: Record<string, string> = {
  draft: "bg-primary-50 text-primary-600 ring-primary-500/20 dark:bg-primary-500/10 dark:text-primary-400",
    ...
    <section className="space-y-5">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <Link href={`/report/customers/${customerId}`} className="inline-flex items-center gap-1 text-sm text-primary-500 dark:text-primary-400 hover:underline"><ArrowLeft className="h-3.5 w-3.5" />Quay lại</Link>
        ...
        <div className="flex items-center gap-2">
          ...
          <Link
            ...
            className="inline-flex items-center gap-1.5 rounded-lg bg-primary-500 px-4 py-2 text-sm font-medium text-white shadow-sm shadow-primary-500/25 hover:brightness-110"
          >
              ...
              <div key={p.id} className="group rounded-xl border border-zinc-200 dark:border-white/[0.07] bg-white dark:bg-[#161616] p-4 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div className="mt-3 flex items-center gap-2 border-t border-zinc-100 dark:border-white/[0.05] pt-3">
                  <Link
                    ...
                    className="inline-flex items-center gap-1 rounded-lg bg-primary-100 dark:bg-primary-500/10 px-3 py-1.5 text-xs font-medium text-primary-600 dark:text-primary-400 hover:bg-primary-100"
                  >
                    Chỉnh sửa →
                  </Link>
                  <button
      ...
      {/* AI analyze error */}
      {aiError && (
        <div className="rounded-lg bg-primary-100 dark:bg-primary-500/10 p-3 text-sm text-primary-600 dark:text-primary-400">
          {aiError}
