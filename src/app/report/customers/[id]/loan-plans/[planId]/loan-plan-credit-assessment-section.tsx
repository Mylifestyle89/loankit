    ...
    <div className="rounded-2xl border border-blue-200 dark:border-blue-500/20 bg-white dark:bg-[#161616] p-5 shadow-sm">
      <div className="flex items-center justify-between mb-4">
        ...
        <button
          ...
          disabled={aiLoading}
          className="inline-flex items-center gap-1.5 rounded-lg bg-gradient-to-r from-violet-600 to-fuchsia-600 px-3 py-1.5 text-xs font-medium text-white shadow-sm hover:shadow-md transition-all disabled:opacity-50"
        >
        ...
        {fields.map((f) => (
          <label key={f.label} className="block">
            ...
            <textarea
              ...
              className="w-full rounded-lg border border-zinc-200 dark:border-white/10 bg-zinc-50 dark:bg-zinc-900 px-3 py-2 text-sm resize-y focus:outline-none focus:ring-2 focus:ring-violet-500/30"
            />
          </label>
        ))}
      </div>
