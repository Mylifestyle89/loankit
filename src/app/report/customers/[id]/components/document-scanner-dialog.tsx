        ...
        {step === "upload" && (
          <>
            ...
            <div
              ...
              className="flex flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-zinc-300 dark:border-white/15 p-6 cursor-pointer hover:border-violet-400 transition-colors"
            >
            ...
            {files.length > 0 && (
              <div className="space-y-2">
                ...
                <button type="button" onClick={handleSubmit}
                  className="w-full rounded-lg bg-gradient-to-r from-violet-600 to-fuchsia-600 px-5 py-2 text-sm font-medium text-white shadow-sm hover:brightness-110">
          ...
          <>
            ...
            <div className="flex gap-3 pt-2">
              ...
              <button onClick={handleConfirm}
                className="rounded-lg bg-gradient-to-r from-violet-600 to-fuchsia-600 px-5 py-2 text-sm font-medium text-white shadow-sm hover:brightness-110">
                Điền vào form
              </button>
            </div>
          </>
