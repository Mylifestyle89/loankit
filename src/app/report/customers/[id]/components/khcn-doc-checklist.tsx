    ...
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
              ...
              <button
                ...
                className={`px-3 py-1.5 text-xs font-medium transition-colors ${
                  method === o.value
                    ...
                    : "bg-white dark:bg-[#1a1a1a] text-zinc-600 dark:text-zinc-400 hover:bg-primary-50 dark:hover:bg-primary-500/10"
                }`}
              >
                {o.label}
              </button>
        ...
        <div className="text-xs text-zinc-500">
          <span className="font-semibold text-primary-500">{checked.size}</span>/{totalDocs} hoàn thành
        </div>
      </div>
      ...
      {loans.length > 0 && (
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="rounded-lg border border-zinc-200 dark:border-white/[0.09] bg-white dark:bg-[#1a1a1a] px-3 py-1.5 text-xs font-medium text-zinc-700 dark:text-zinc-300 focus:outline-none focus:ring-2 focus:ring-primary-500/40"
          >
            {loans.map((l) => (
        ...
        <div className="rounded-xl border border-zinc-200 dark:border-white/[0.07] bg-white dark:bg-[#161616] p-3 space-y-2">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="cursor-pointer text-xs text-primary-500 dark:text-primary-400 hover:underline"
            >
                    ...
                    >
                      <button
                        ...
                        className={`flex h-5 w-5 shrink-0 items-center justify-center rounded border transition-colors ${
                          isChecked
                            ...
                            : "border-zinc-300 dark:border-white/[0.15] hover:border-primary-400"
                        }`}
                      >
                      ...
                      {customerId && (
                        <button
                          ...
                          className="shrink-0 rounded-md p-1.5 text-primary-400 hover:bg-primary-100 hover:text-primary-500 dark:hover:bg-primary-400/10 transition-colors"
                          title="Tạo báo cáo"
                        >
                          {generating === t.path
                            ? <div className="h-3.5 w-3.5 animate-spin rounded-full border border-primary-300 border-t-primary-500" />
                      ...
                      <button
                        ...
                        className="shrink-0 rounded-md p-1.5 text-zinc-400 hover:bg-primary-50 hover:text-primary-500 dark:hover:bg-primary-500/10 transition-colors"
                        title="Tải mẫu gốc"
                      >
