...
export const QSD_LAND_KEYS = ["land_address", "land_area", "land_area_words", "lot_number", "map_sheet", "land_purpose", "land_use_term", "land_origin", "ownership_form", "shared_area", "private_area", "asset_usage_status"];
