  ...
  return (
    <div
      className={`border rounded-lg p-4 transition-colors cursor-pointer ${
        isActive
          ? "border-primary-400 dark:border-primary-500/40 bg-primary-50/50 dark:bg-primary-500/10 ring-1 ring-primary-400/30"
      ...
      <div className="flex items-start justify-between gap-3">
        <div className="flex-1">
          <div className="flex items-center gap-2 mb-2">
            {isActive && <Check className="h-4 w-4 text-primary-500 dark:text-primary-400" />}
