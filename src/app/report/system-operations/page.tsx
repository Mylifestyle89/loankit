    ...
    <section className="space-y-5 max-w-6xl">
      ...
      <div className="relative overflow-hidden rounded-2xl border border-brand-100 dark:border-brand-500/10 bg-gradient-to-br from-brand-50 via-white to-brand-100 dark:from-brand-950/30 dark:via-[#242220] dark:to-brand-900/20 p-5">
        ...
        <div className="relative">
          <h1 className="text-xl font-bold tracking-tight text-brand-600 dark:text-brand-400">
            {t("nav.systemOps")}
          </h1>
        ...
        {/* Tab switcher */}
        <div className="relative mt-4 flex gap-1 rounded-lg bg-white/60 dark:bg-white/[0.04] p-1 border border-brand-100/60 dark:border-white/[0.06] w-fit">
          {tabs.map((tab) => {
            const Icon = tab.icon;
