    ...
    <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-md space-y-3 rounded-lg bg-white dark:bg-[#141414]/90 p-4 shadow-xl">
        ...
        <div className="space-y-1">
          <label className="text-xs text-zinc-500 dark:text-slate-300" htmlFor="import-group-template-select">
            Mẫu nguồn
          </label>
          <select
        ...
        <div className="space-y-1">
          <label className="text-xs text-zinc-500 dark:text-slate-300" htmlFor="import-group-path-select">
            Nhóm dữ liệu
          </label>
          <select
        ...
        <div className="mt-2 flex justify-end gap-2">
          <button
            type="button"
            onClick={onClose}
            className="rounded-md border border-zinc-200 dark:border-white/[0.09] dark:text-slate-200 px-3 py-1.5 text-xs hover:bg-violet-50/30 dark:hover:bg-white/[0.06]"
          >
            Hủy
          </button>
          <button
            ...
            className="rounded-md bg-gradient-to-r from-violet-600 to-fuchsia-600 px-3 py-1.5 text-xs text-white disabled:opacity-50"
          >
            Thêm nhóm dữ liệu
          </button>
        </div>
