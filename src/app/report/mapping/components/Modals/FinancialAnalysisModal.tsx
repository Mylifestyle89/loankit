...
export function FinancialAnalysisModal({ isOpen, onClose, fieldCatalog, onApplyValues, embedded = false }: Props) {
  ...
  const cardContent = (
    <motion.div
      ...
      className="w-full max-w-4xl rounded-2xl border border-slate-200/60 dark:border-white/[0.08] bg-white/95 dark:bg-[#141414]/90 shadow-[0_8px_40px_rgb(0,0,0,0.12)] dark:shadow-[0_8px_40px_rgb(0,0,0,0.5)] backdrop-blur-md flex flex-col max-h-[90vh]"
