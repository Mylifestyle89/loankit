          ...
          <div className="border-t border-zinc-200 dark:border-white/[0.07] px-5 py-3">
            {!showCreateForm ? (
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-zinc-300 dark:border-white/[0.12] px-4 py-2.5 text-sm font-medium text-zinc-600 dark:text-slate-300 transition-colors hover:border-violet-400 hover:text-violet-600 dark:hover:text-violet-400"
              >
              ...
              <div className="space-y-3">
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border border-zinc-200 dark:border-white/[0.09] bg-zinc-50 dark:bg-white/[0.04] px-3 py-2 text-sm text-zinc-900 dark:text-slate-100 focus:border-violet-400 focus:outline-none focus:ring-2 focus:ring-violet-400/30"
                    />
                  </div>
                  <div>
                ...
                <div className="flex items-center justify-end gap-2">
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 rounded-lg bg-gradient-to-r from-violet-600 to-fuchsia-600 px-4 py-2 text-sm font-medium text-white shadow-sm shadow-violet-500/25 transition-all hover:brightness-110 disabled:opacity-60"
                  >
