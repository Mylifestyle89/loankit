        ...
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/40 p-4">
            <div className="w-full max-w-md space-y-3 rounded-lg bg-white dark:bg-[#141414]/90 p-4 shadow-xl">
                ...
                <div className="space-y-2">
                    <p className="text-xs text-coral-tree-600 dark:text-slate-300">{t("mapping.merge.selectLabel")}</p>
                    <div className="max-h-56 space-y-1 overflow-auto rounded border border-coral-tree-200 dark:border-white/[0.09] p-2">
                ...
                <div className="space-y-1">
                    <label className="text-xs text-coral-tree-600 dark:text-slate-300" htmlFor="merge-target-group-input">
                ...
                <div className="space-y-1">
                    <p className="text-xs text-coral-tree-600 dark:text-slate-300">{t("mapping.merge.orderLabel")}</p>
                ...
                <div className="rounded-md border border-coral-tree-200 dark:border-white/[0.07] bg-coral-tree-50 dark:bg-white/[0.04] p-2 text-xs text-coral-tree-700 dark:text-slate-300">
