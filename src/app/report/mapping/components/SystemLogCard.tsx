...
> = {
  ...
  light: {
    ai: {
      dot: "bg-indigo-500",
      rail: "bg-indigo-200 dark:bg-indigo-400/30",
      badge: "bg-indigo-50 dark:bg-indigo-500/10 text-indigo-700 dark:text-indigo-400 ring-1 ring-indigo-200 dark:ring-indigo-500/30",
