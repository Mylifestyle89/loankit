    ...
    <div className="flex flex-wrap items-center gap-3">
      ...
      <div className="relative flex-1 min-w-[240px]">
        ...
        <input
          ...
          className="w-full rounded-lg border border-zinc-200 dark:border-white/[0.09] bg-white dark:bg-[#1a1a1a] pl-9 pr-9 py-2 text-sm shadow-sm transition-all duration-150 placeholder:text-zinc-400 dark:placeholder:text-slate-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/40"
        />
        {search && (
          <button
            type="button"
      ...
      <select
        ...
        className="cursor-pointer rounded-lg border border-zinc-200 dark:border-white/[0.09] bg-white dark:bg-[#1a1a1a] px-3 py-1.5 text-xs font-medium shadow-sm transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-500/40"
      >
      ...
      <div className="ml-auto flex items-center gap-1 rounded-lg border border-zinc-200 dark:border-white/[0.09] bg-white dark:bg-[#1a1a1a] p-0.5">
        <button
          ...
          className={`cursor-pointer rounded-md p-1.5 transition-colors ${viewMode === "table" ? "bg-brand-100 text-brand-600 dark:bg-brand-500/15 dark:text-brand-400" : "text-zinc-400 hover:text-zinc-600 dark:hover:text-slate-300"}`}
          title="Dạng bảng"
        >
        ...
        <button
          ...
          className={`cursor-pointer rounded-md p-1.5 transition-colors ${viewMode === "card" ? "bg-brand-100 text-brand-600 dark:bg-brand-500/15 dark:text-brand-400" : "text-zinc-400 hover:text-zinc-600 dark:hover:text-slate-300"}`}
          title="Dạng thẻ"
        >
