...
function Verify2FAForm() {
  ...
  return (
    <div className="relative z-10 w-full max-w-sm rounded-2xl border border-white/10 bg-white/[0.04] p-8 shadow-2xl backdrop-blur-sm">
      <div className="mx-auto mb-6 flex h-10 w-10 items-center justify-center rounded-xl bg-gradient-to-br bg-brand-500 shadow-md">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <input
          ...
          className="w-full rounded-lg border border-white/10 bg-white/[0.06] px-3 py-3 text-center text-lg font-mono tracking-[0.3em] text-white placeholder-slate-500 outline-none transition focus:border-brand-500/50 focus:ring-1 focus:ring-brand-500/30"
        ...
        <button
          ...
          className="w-full rounded-lg bg-gradient-to-r bg-brand-500 py-2.5 text-sm font-medium text-white transition hover:brightness-110 disabled:cursor-not-allowed disabled:opacity-50"
        >
