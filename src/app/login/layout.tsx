  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center bg-[#050505] px-4 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -top-32 -left-32 h-96 w-96 rounded-full bg-indigo-600/20 blur-[100px] animate-[float_8s_ease-in-out_infinite]" />
        <div className="absolute -bottom-24 -right-24 h-80 w-80 rounded-full bg-fuchsia-600/15 blur-[100px] animate-[float_10s_ease-in-out_infinite_reverse]" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-64 w-64 rounded-full bg-violet-500/10 blur-[80px] animate-[pulse_6s_ease-in-out_infinite]" />
      </div>
