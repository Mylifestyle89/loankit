/**
 * Template field operations — CRUD for field templates and customer assignment.
 */
...
export async function listFieldTemplates(params: { customerId?: string; withUsage?: boolean }) {
