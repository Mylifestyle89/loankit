  ...
  if (collapsed) {
    return (
      <button
        ...
        className="flex h-full w-10 flex-col items-center justify-center border-l border-slate-200/70 bg-slate-50/80 text-slate-500 transition-colors hover:bg-brand-100 hover:text-brand-500 dark:border-white/[0.08] dark:bg-[#141414] dark:text-slate-400 dark:hover:bg-brand-1000/10 dark:hover:text-brand-400"
      >
      ...
      <div className="border-b border-slate-200/70 px-3 py-2 dark:border-white/[0.08]">
        <div className="relative">
          ...
          <input
            ...
            className="h-8 w-full rounded-lg border border-slate-200 bg-slate-50/50 pl-8 pr-3 text-xs text-slate-700 placeholder:text-slate-400 focus:border-brand-400 focus:outline-none focus:ring-1 focus:ring-brand-400 dark:border-white/[0.09] dark:bg-white/[0.04] dark:text-slate-200 dark:placeholder:text-slate-500"
          />
        </div>
      </div>
      ...
      <div className="flex items-center justify-between gap-1 border-b border-slate-200/70 px-3 py-1.5 dark:border-white/[0.08]">
        ...
        <div className="flex items-center gap-1">
          <button
            type="button"
            onClick={expandAll}
            className="rounded px-2 py-0.5 text-[11px] font-medium text-brand-500 transition-colors hover:bg-brand-100 dark:text-brand-400 dark:hover:bg-brand-1000/10"
          >
            Mở tất cả
          </button>
          <button
                  ...
                  {fields.map((field) => {
                    ...
                    return (
                      <button
                        ...
                        className="group flex w-full items-center gap-2 px-3 py-1.5 text-left transition-colors hover:bg-brand-100/60 dark:hover:bg-brand-1000/10"
                      >
                        ...
                        <span className="flex-shrink-0">
                          {isCopied ? (
                            ...
                            <Copy className="h-3.5 w-3.5 text-slate-300 transition-colors group-hover:text-brand-500 dark:text-slate-600 dark:group-hover:text-brand-400" />
                          )}
                        </span>
                      </button>
                    );
