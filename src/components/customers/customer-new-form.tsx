      ...
      <DropdownOptionsProvider prefix="customer.">
        ...
        >
          ...
          <div className="flex gap-2">
            <span className="rounded-lg px-4 py-2 text-sm font-medium bg-violet-100 text-violet-700 ring-1 ring-violet-500/30 dark:bg-violet-500/15 dark:text-violet-400">
              {typeLabel}
            </span>
          </div>
